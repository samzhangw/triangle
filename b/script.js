document.addEventListener('DOMContentLoaded', () => {
    ...
    function handleCanvasClick(e) {
        ...
        if (!clickedDot) {
            if (selectedDot1) cancelLine(); // 如果點到空白處，取消
            return;
        }
        ...
        if (selectedDot1 === null) {
            ...
            if (clickedDot === selectedDot1) {
                ...
                if (isValidPreviewLine(selectedDot1, clickedDot, lines)) {
                    ...
                    if (actionBar) actionBar.classList.add('visible'); // 顯示確認列
                } else {
                    // 點了無效的第二個點
                    cancelLine();
                }
    ...
    function endGame() {
        ...
        if (isBatchRunning) {
            ...
            if (actionBar) actionBar.classList.remove('visible'); // (新) 確保隱藏
    ...
    function triggerAIMove() {
        ...
        aiWorker.postMessage({
            ...
            gameState: {
                ...
                isScoreAndGoAgain: isScoreAndGoAgain // (**** 新功能 ****) 傳遞規則
            }
        });
    }
    ...
    function applyMoveToBoard(dotA, dotB, player) {
        ...
        return {
            ...
            scoreGained: scoreGained // (**** 新功能 ****) 回傳得分
        };
    }
    ...
    function removeCanvasListeners() {
        ...
        canvas.removeEventListener('click', handleCanvasClick); // (點擊模式)
    }
    ...
    // 綁定 PNG 匯出按鈕 (手動)
    if (exportPNGButton) exportPNGButton.addEventListener('click', () => exportCanvasAsPNG(null)); 
    if (exportPNGButtonModal) exportPNGButtonModal.addEventListener('click', () => exportCanvasAsPNG(null)); 
